...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ItemList = __webpack_require__(160);
	var BasketBox = __webpack_require__(164);
	var NavBar = __webpack_require__(165);
	
	var itemData = __webpack_require__(161);
	var voucherData = __webpack_require__(162);
	...
	var ShopBox = React.createClass({
	  ...
	  listAllItems: function listAllItems(items) {
	    var allItems = [];
	  ...
	  filterCategory: function filterCategory(gender) {
	    ...
	    try {
	      for (var _iterator2 = this.state.items[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	  ...
	  inStock: function inStock() {
	    ...
	    try {
	      for (var _iterator3 = this.state.items[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
	  ...
	  addItemToBasket: function addItemToBasket(itemId) {
	    ...
	    try {
	      for (var _iterator4 = this.inStock()[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	  ...
	  totalPriceOfBasket: function totalPriceOfBasket(shoppingBasket) {
	    var totalCost = 0;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ItemList = React.createClass({
	  ...
	  addItemToBasket: function addItemToBasket(e) {
	  ...
	  render: function render() {
	    ...
	    var allItems = this.props.filteredCategory.map(function (items) {
	      return React.createElement(
	        ...
	        React.createElement("img", { src: items.image, height: "70", width: "70" }),
	        React.createElement(
	          "button",
	          { onClick: this.addItemToBasket, value: items.id },
	          "+ Basket"
	        )
	      );
	    }.bind(this));
...
/***/ function(module, exports) {
	...
	module.exports = [{
	  ...
	  image: "/images/toeCourtShoes.jpeg",
	  gender: "Womans",
	  colour: "Patent Black",
	  category: "Footwear",
	  price: 99.00,
	  ...
	  id: 4,
	  product: "Flip Flops - Red",
	  image: "/images/flipFlopsRed.jpg",
	  gender: "Mens",
	  colour: "Red",
	  category: "Footwear",
	  price: 19.00,
	  ...
	  id: 5,
	  product: "Flip flops - Blue",
	  image: "/images/flipFlopsBlue.jpg",
	  gender: "Mens",
	  colour: "Blue",
	  category: "Footwear",
	  price: 19.00,
	  ...
	  image: "/images/goldButtonCardigan.jpeg",
	  gender: "Womans",
	  colour: "Black",
	  category: "Casualwear",
	  price: 167.00,
	  ...
	  id: 9,
	  product: "Fine Stripe Short Sleeve Shirt",
	  image: "/images/cottonShirtGreen.jpg",
	  gender: "Mens",
	  colour: "Green",
	  category: "Casualwear",
	  old_price: 49.99,
	  ...
	  image: "/images/pocketBlazer.jpeg",
	  gender: "Mens",
	  colour: "Deer",
	  category: "Formalwear",
	  price: 175.50,
...
/***/ function(module, exports) {
	...
	module.exports = [{
	  voucher: "£5.00 off your order",
	  code: 92834
	}, {
	  voucher: "£10.00 off when you spend over £50.00",
	  code: 92835
	}, {
	  voucher: "£15.00 off when you have bought at least one footwear item and spent over £75.00",
	  code: 92836
	}];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BasketBox = React.createClass({
	  ...
	  handleVoucherChange: function handleVoucherChange(e) {
	  ...
	  render: function render() {
	    var allItemsInBasket = this.props.shoppingBasket.map(function (items) {
	      return React.createElement(
	        ...
	        React.createElement('input', { type: 'submit', value: 'x' })
	      );
	    });
